# Class for NRJMOBILE to get usage data from mobile API
# version 0.1
# MIT license - 2024 Nicolas GOLLET
...
class nrjmobile:
    ...
    def getDataUsage(self, _retry=0):
        ...
        if "/fr/client/wsmobile/sfcv3/PremiereConnexionMdp.html" in  response.text:
            print("Account not initialized. Log in to nrjmobile.fr and choose a password!")
            return False, None, None, None
